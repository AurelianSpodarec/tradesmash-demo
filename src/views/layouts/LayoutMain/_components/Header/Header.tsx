...
function Header() {
    ...
    return (
        ...
        <div className="container mx-auto flex flex-wrap justify-between p-5 flex-col md:flex-row items-center">
            ...
            <Link to="/dashboard" className="inline-flex items-center bg-blue-500 border-0 py-1.5 px-4 focus:outline-none hover:bg-gray-200 rounded-lg text-white mt-4 md:mt-0">
                Get Started
            </Link>
            </div>
