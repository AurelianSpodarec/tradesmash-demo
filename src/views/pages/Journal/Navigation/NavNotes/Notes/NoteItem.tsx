...
function NoteItem({ item, onClick, isActive }:any) {
    ...
    return (
        <li onClick={onClick} className={` ${isActive ? "bg-gray-100/20" : "bg-white"} w-full  hover:bg-gray-300/10 border border-transparent hover:border-skin-brand-100/20 px-4 `}>
