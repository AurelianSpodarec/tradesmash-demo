        ...
        <LayoutMain> 
            ...
            <div className="px-6 py-24 sm:px-6 sm:py-32 lg:px-8">
                ...
                <div className="mt-10 flex items-center justify-center gap-x-6">
                    <a
                    href="#"
                    className="rounded-md bg-skin-brand-600/70 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-skin-brand-500/70 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-skin-brand-600/70"
                    >
                    Get started
                    </a>
